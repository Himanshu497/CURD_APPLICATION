...
1. Setup codebase
    ...
    1. clone the code in a directory
            ...
            git clone https://github.com/Himanshu497/CURD_APPLICATION.git
    2. go in the directory `cd flask//filed_audio_file_server`
...
3. create the table in audioserver database
     1. in `.env` file add the data as below
            ...
            # example
            # DATABASE_URL="postgresql://himanshu:12345@localhost:5432/audioserver"
            DATABASE_URL="postgresql://<himanshu>:<12345>@<server host>:<port>/<database name>
...
1. Clone the repo from github
    `git clone https://github.com/Himanshu497/CURD_APPLICATION.git`
2. in terminal go to folder , `cd flask//filed_audio_file_server`
3. setup flask app 
